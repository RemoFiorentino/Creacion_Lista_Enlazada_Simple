========================================================================
    APLICACIÓN: Creacion_Lista Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Creacion_Lista.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Creacion_Lista.

Creacion_Lista.vcxproj
...
Creacion_Lista.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Creacion_Lista.pch y un archivo de tipos precompilados llamado StdAfx.obj.
